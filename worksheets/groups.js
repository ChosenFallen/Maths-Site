...
export const WORKSHEET_GROUPS = [
    ...
    {
        label: "Percentages & Conversions",
        types: [
            "percentage-of-amount",
            "percentage-change",
            "reverse-percentages",
            "percentages-as-percentage",
            "percentages-multipliers",
            "percentages-repeated",
    ...
    {
        label: "Algebra - Fractions & Advanced",
        types: [
            "simplify-algebraic-fractions",
            "algebraic-fractions-add-sub",
            "algebraic-fractions-mul-div",
